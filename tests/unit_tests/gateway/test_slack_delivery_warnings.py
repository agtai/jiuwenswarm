...
job created inside a Slack turn carries that turn's session id, and the session
...
# What a job created from the web panel or the TUI carries instead.
_WEB_SESSION = "web_42"

_SLACK_ROUTING_LOGGER = "jiuwenswarm.gateway.cron.slack_routing"
