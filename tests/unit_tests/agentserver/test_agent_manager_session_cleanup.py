...
from jiuwenswarm.server.runtime.agent_manager import AgentManager, _make_agent_cache_key, _normalize_project_dir
...
async def test_same_key_creation_waits_for_old_root_cleanup() -> None:
    ...
    # Seed the same key get_agent uses on this host (Windows normalizes paths).
    cache_key = _make_agent_cache_key("code", "normal", _normalize_project_dir("/tmp/shared-project"))
