...
the tool at all, what the request carries, what a result is reduced to, and how
...
class _SlackApiError(Exception):
    """The shape slack_sdk raises: an exception carrying the failed response."""
...
def test_the_card_states_what_the_tool_returns_and_what_it_does_not() -> None:
    ...
    # And the claim the earlier version made, which was never ours to make.
