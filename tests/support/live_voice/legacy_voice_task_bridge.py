"""Legacy fake-vertical mapping; never imported by production."""
from dataclasses import dataclass
from jiuwenswarm.common.schema.live_voice_contract_v2 import ErrorCode, InputCommitState, ScopeRef
from jiuwenswarm.server.runtime.formal_tasks.voice_task_bridge import VoiceTaskBridgeViolation
from tests.support.live_voice.legacy_task_core import TaskCommand, TaskSpec
