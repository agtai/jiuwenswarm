...
from jiuwenswarm.server.runtime.work.native_foreground import NATIVE_FOREGROUND
...
class NativeWorkRuntime:
    ...
    async def wait_for_observation(self, *, scope: ScopeRef, after, wait_ms: int) -> None:
        from jiuwenswarm.common.schema.native_business_observation import observation_cursor, MAX_OBSERVATION_WAIT_MS
        self._require_owner()
