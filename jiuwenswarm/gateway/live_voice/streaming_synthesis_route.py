...
class StreamingSynthesisRouteOwner:
    ...
    async def cancel(
        ...
        *,
        ...
        caller_cancel_depth = 0 if caller_task is None else caller_task.cancelling()
        try:
            ...
            if (
                caller_task is None
                or caller_task.cancelling() <= caller_cancel_depth
            ):
                raise
                ...
                try:
                    ...
                    if cleanup_task.done():
                        try:
                            ...
                            pass
                        break
                    if caller_task.cancelling() <= caller_cancel_depth:
        ...
        *,
        ...
        try:
            ...
            if (
                ...
                and caller_task.cancelling() > caller_cancel_depth
            ):
                raise
            return False
        except _PROCESS_CONTROL:
