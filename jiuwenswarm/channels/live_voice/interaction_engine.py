...
The Port validates proposed intentions without classifying raw audio, choosing
product VAD/EOT parameters, or holding Conversation Runtime, Agent, Tool, Task,
history, audio, or cancel authority. The scripted conformance implementation
lives in tests.support.live_voice.scripted_cascade.
"""
