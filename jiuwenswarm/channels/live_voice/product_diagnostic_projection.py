...
from jiuwenswarm.server.runtime.presentation.task_progress_return import TaskProgressNotificationIntent, TaskProgressTextEvent
from typing import TYPE_CHECKING
import logging

if TYPE_CHECKING:
    from jiuwenswarm.channels.live_voice.product_composition_registry import _ProgressDelivery

# Preserve the original logger identity for handlers and diagnostic consumers.
logger = logging.getLogger("jiuwenswarm.channels.live_voice.product_composition_registry")
