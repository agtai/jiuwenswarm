      ...
      {railTab === 'receipts' && (
        <div className="doc-workbench__rail-body" data-testid="doc-workbench-receipts">
          ...
          <DetailTimeline
            ...
            lineage={NO_LINEAGE}
            receipts={receipts}
            note={note ? <p className="text-xs text-red-600" data-testid="doc-workbench-receipt-note">{note}</p> : null}
            onLocate={onLocate}
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={`rounded-md px-1.5 py-0.5 text-[11px] font-medium hover:ring-1 hover:ring-border-strong ${
                armOn ? 'bg-[#eff4fe] text-[#2563eb]'
                  : watchOn ? 'bg-[#fdecea] text-[#b42318]' : 'bg-bg-muted text-text-muted'
              }`}
            >
