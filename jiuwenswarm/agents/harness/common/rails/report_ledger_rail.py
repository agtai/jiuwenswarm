...
# read-only answer ("文档已读取", "I have written a summary below") corrupts the very
# reports it exists to keep honest. A Chinese claim names a completed write verb
# (``已修改``); an English one needs a document noun in the same sentence as the
# completed verb, so "I have written a summary" is not a claim and "I have written
# it into the document" is.
