...
| `D101_W2_NEW_ENVIRONMENT_MANUAL_HANDOFF_2026-08-11.md` | Historical Gate-era new-environment handoff and abandoned unsigned local scaffold boundary; its signing sequence is retired by D-071 |
...
| `D105_W2_SIGNED_GATE_CODE_REMOVAL_REVIEW_2026-08-11.md` | Three-round removal record for the retired W2 signed-evidence Gate, including retained product boundaries, verification, single-commit invariant and the exact independent-review limitation |
