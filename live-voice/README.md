...
| Week 2 cumulative Demo implementation, integration, portable rehearsal recovery or acceptance | Current [90% Demo execution packet](roadmap/DEMO_90_EXECUTION_2026-08-07.md), [W2 source-candidate review](D90_W2_INTEGRATED_DEMO_REVIEW_2026-08-08.md), current [P3 D0 attempt-binding/restart repair](D95_P3_D0_ATTEMPT_BINDING_REPAIR_2026-08-08.md), [final automation-attempt record](D98_W2_FINAL_AUTOMATION_ATTEMPT_2026-08-10.md), [P3 origin-route reconciliation review](D99_P3_ORIGIN_ROUTE_RECONCILIATION_REVIEW_2026-08-11.md), [P3 terminal replay and unsigned validation-ready review](D100_P3_TERMINAL_REPLAY_VALIDATION_READY_2026-08-11.md), [new-environment manual handoff](D101_W2_NEW_ENVIRONMENT_MANUAL_HANDOFF_2026-08-11.md), [signed-rehearsal fault-probe repair](D102_W2_SIGNED_REHEARSAL_FAULT_PROBE_REPAIR_2026-08-11.md), current [unsigned manual product acceptance](D103_W2_UNSIGNED_MANUAL_PRODUCT_ACCEPTANCE_2026-08-11.md), [Integrated Demo acceptance](validation/INTEGRATED_DEMO_ACCEPTANCE.md), [Integrated showcase](demo/INTEGRATED_SHOWCASE.md), [E2E runbook](runbooks/E2E_RUNBOOK.md) section 7.1 including the validation-ready gate, the repository-local [portable rehearsal toolkit](../scripts/live_voice/w2_rehearsal/README.md), roadmap, and current replacement ledger in STATUS |
...
| `D90_W2_INTEGRATED_DEMO_REVIEW_2026-08-08.md` | Frozen W2 cumulative source candidate, D-053 review closure, cumulative verification, baseline exclusions and exact external Gate boundary for implementation commit `2fdf849a`; STATUS owns current score and next work |
...
| `D102_W2_SIGNED_REHEARSAL_FAULT_PROBE_REPAIR_2026-08-11.md` | Invalid signed rehearsal boundary, P1 fault-probe identity/timeout repair, D-053 review and exact fresh-candidate remainder |
| `D103_W2_UNSIGNED_MANUAL_PRODUCT_ACCEPTANCE_2026-08-11.md` | Evidence-disabled non-Jabra physical P1/P2 product acceptance, exact real Terminal result, audible playout, successor behavior and explicit no-Gate-credit boundary |
...
| `roadmap/POST_V0_DELIVERY_ROADMAP.md` | Logical delivery windows, target scope/order, replacement scoring, risk-proportional closure and the D-060/D-061/D-062 adaptive execution model; calendar timing is not frozen |
...
| `roadmap/DEMO_90_EXECUTION_2026-08-07.md` | Current W2-first task contract, adaptive worker graph, package boundaries, effort bands and cumulative exit order; STATUS alone owns mutable progress |
