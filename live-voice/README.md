...
| LiveVoice slimming / AgentCore downshift | [Slimming master plan](roadmap/LIVEVOICE_SLIMMING_MASTER_PLAN.md) is the single entry; open its linked reviews only for the package being executed. Slimming is not activated until the trigger decision in its §1.3 is recorded. For "what does this LiveVoice module correspond to in Hermes" read the [official Hermes voice comparison](reviews/OPENJIUWEN_LIVEVOICE_OFFICIAL_HERMES_VOICE_COMPARISON_2026-09-06.md) |
