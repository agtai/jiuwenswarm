...
> Updated: 2026-09-01. This is the only mutable source for current product
...
- **Status/source:** **OPEN / PARTIAL, not the current implementation packet**
  on integrated product/test source
