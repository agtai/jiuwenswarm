...
| Speech Recognition | **PARTIAL.** Controlled OpenAI Streaming/Batch STT and browser fallback work. No-Browser real-Provider VAD screening at `048f944e4` rejected fixed 900/800 ms and retained 1200 ms after A1/A2 passed 40/40 while each lower candidate passed 14/20 | Provider-neutral configuration, fixed accuracy/latency corpus, robust fallback/cancel, semantic/adaptive VAD evaluation and broader device/network validation | Audio I/O, media route and benchmark owner; [VAD/EOT causal result](evidence/VAD_EOT_CAUSAL_RESULT_2026-08-21.md) |
