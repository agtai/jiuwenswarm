...
- 日期：2026-08-23
- 状态：Accepted scoped 实现决定（基线 `5415a3d3fb2c3c50b0b59fb5f5ad3a0aec423465`，分支 `hx/0823_generation_interruption`）。本决定关闭"生成期免提语音无法中断或取代该回答"这一实现缺口，不授予物理、延迟、flag-on 上线、controlled-candidate、feature-complete、Production 或 `develop` credit。
