...
| 会话与业务协调 M4+M5 | 38,708 | 38,708 | 38,708 |
...
最新 Work producer 管理收敛：Voice **112,366**、Host **48,371**、SDK **33,875**，
...
[模块分桶](../evidence/DEEP_WORK_OWNER_MODULES_20260914.json)记录当前口径。
