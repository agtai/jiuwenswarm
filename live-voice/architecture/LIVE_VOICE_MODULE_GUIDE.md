...
> 2026-09-15 旧订阅模式删除后：Voice **111021** / Host **48022** / SDK **34188**，合计净增 **193231**；相对本轮实际 HEAD 基线 **194530** 净减 **1299**。累计生产新增 **377** / 删除 **1676**，不含测试和文档。本批生产新增8行、删除142行，净减134行：删除非原子订阅启动、旧来源协议和模式开关；两个 Host 入口继续使用既有原子事件语义。兼容范围由用户明确限定为这两个仓库。[逐项决策](../reviews/MANAGEMENT_REPLACEMENT_20260915.md)、[当前差量与合并模块汇总](../evidence/MANAGEMENT_ATOMIC_SUBSCRIPTION_20260915.json)、[前一批差量](../evidence/MANAGEMENT_FRONTEND_RETIREMENT_20260915.json)。后文数字保留各自历史阶段。
