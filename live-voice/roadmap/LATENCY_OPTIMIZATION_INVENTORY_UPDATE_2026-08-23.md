...
4. Use the deployed waterfall to choose between an Adaptive WebAudio startup
   ...
   UPDATE 2026-08-23: receipt settlement is DONE (ref #5), so this choice now
   resolves to the Adaptive WebAudio lead — whose missing Chrome/device
   evidence was produced today (579 ms dead wait, zero underrun).
