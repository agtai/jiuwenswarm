...
> D-052 supersedes the non-Sol owner/allocation language below, D-060 later creates a bounded Alpha parallel exception, and D-055 supersedes Windows/X-WIN carrier language. The original design/oracles remain historical inputs; current execution, carrier and closure come only from decisions, STATUS and the actual diff/tests.
...
- Historical stage/decision sources: Post-V0 Foundation Alpha and D-026 through D-034, D-039 and D-041. Current risk/review rules are in root [TESTING.md](../TESTING.md); long-term P1/P2/P3 contracts remain in [FULL_SOLUTION_2026-07-30.md](architecture/FULL_SOLUTION_2026-07-30.md).
