...
> Historical audit from the source slimming branch. Paths and counts below describe
> that source snapshot; current ownership and verification are in
> [the 2026-09-13 integration record](SHARED_RUNTIME_INTEGRATION_20260913.md).
