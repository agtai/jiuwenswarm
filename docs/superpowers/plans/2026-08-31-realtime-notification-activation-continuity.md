...
**Spec:** User-approved Tier-3 execution packet attached to the current goal; `live-voice/architecture/OPENAI_REALTIME_NATIVE_INTERACTION_ENGINE_2026-08-25.md`; `live-voice/decisions/DECISIONS.md` D-098/D-099/D-100; root `TESTING.md` Tier-3 rules.
