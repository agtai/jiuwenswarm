...
当前源码分支使用锁定的 AgentCore 源码。首次同步依赖前，必须按
[源码安装指南](../../scripts/sdk_patches/README.md)准备该 checkout；后续继续
从该源码安装，不替换为单独下载的 AgentCore 安装包。
